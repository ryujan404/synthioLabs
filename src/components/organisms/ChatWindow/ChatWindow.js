...
const ChatWindow = () => {
  ...
  if (!activeChat) {
    return (
      <div className="chat-window rounded-xl overflow-hidden flex items-center justify-center h-full bg-white relative">
        <div className="chat-window__empty text-center">
          <h2 className="chat-window__empty-title text-3xl font-bold text-gray-900 mb-2">
            Chat Interface
          </h2>
          <p className="chat-window__empty-text text-gray-600">
  ...
  return (
    <div className="chat-window rounded-xl overflow-hidden flex flex-col h-full bg-white relative">
      {/* Header */}
      <ChatHeader user={activeChat} />

      {/* Messages */}
      <div className="chat-window__messages flex-1 overflow-y-auto px-6 py-6">
      ...
      {/* Input */}
      <div className="pb-8 bg-gradient-to-b from-transparent to-white">
